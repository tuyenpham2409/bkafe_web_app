...
// Helper to remove Vietnamese accents and generate emails
...
function generateEmail(username, displayName) {
  ...
  const name = parts[parts.length - 1]; // last name
  let abbreviations = '';
...
async function run() {
  ...
  const p1 = await Post.create({
    ...
    topic: 'tai-lieu',
    author: users['20233884']._id, // Nguyễn Quang Tùng
    status: 'approved',
    views: 142,
    shares: 4,
  });
  ...
  await Comment.create({
    post: p1._id,
    author: users['20233886']._id, // Lê Hà Hải Vân
  ...
  await Comment.create({
    post: p1._id,
    author: users['20233882']._id, // Phạm Kiều Trang
  ...
  await Comment.create({
    post: p1._id,
    author: users['20233885']._id, // Phạm Minh Tuyên
  ...
  const p2 = await Post.create({
    ...
    topic: 'tai-lieu',
    author: users['20233880']._id, // Nguyễn Thị Anh Thơ
    status: 'approved',
    views: 250,
    shares: 11,
  });
  ...
  const c2_1 = await Comment.create({
    post: p2._id,
    author: users['20233878']._id, // Ngô Thu Thảo
  ...
  await Comment.create({
    post: p2._id,
    parent: c2_1._id,
    author: users['20233876']._id, // Bùi Thanh Thảo
  ...
  await Comment.create({
    post: p2._id,
    author: users['20233874']._id, // Bùi Thái Sơn
  ...
  await Comment.create({
    post: p2._id,
    author: users['20233872']._id, // Nguyễn Yến Nhi
  ...
  const p3 = await Post.create({
    ...
    topic: 'tai-lieu',
    author: users['20233870']._id, // Nguyễn Thành Nam
    status: 'approved',
    views: 65,
    shares: 1,
  });
  await Comment.create({
    post: p3._id,
    author: users['20233868']._id, // Vũ Đức Minh
  ...
  const p4 = await Post.create({
    ...
    topic: 'hoc-tap',
    author: users['20233866']._id, // Bùi Tuấn Minh
    status: 'approved',
    views: 198,
    shares: 5,
  });
  ...
  await Comment.create({
    post: p4._id,
    author: users['20233864']._id, // Trần Văn Long
  ...
  await Comment.create({
    post: p4._id,
    author: users['20233862']._id, // Đoàn Ngọc Linh
  ...
  await Comment.create({
    post: p4._id,
    author: users['20233860']._id, // Nguyễn Anh Kiệt
  ...
  const p5 = await Post.create({
    ...
    topic: 'hoc-tap',
    author: users['20233858']._id, // Lê Xuân Kiên
    status: 'approved',
    views: 145,
    shares: 3,
  });
  ...
  await Comment.create({
    post: p5._id,
    author: users['20233856']._id, // Vũ Ngọc Đăng Khoa
  ...
  const c5_2 = await Comment.create({
    post: p5._id,
    author: users['20233854']._id, // Nguyễn Thị Thúy Huyền
  ...
  await Comment.create({
    post: p5._id,
    parent: c5_2._id,
    author: users['20233852']._id, // Nguyễn Minh Huy
  ...
  await Comment.create({
    post: p5._id,
    parent: c5_2._id,
    author: users['20233850']._id, // Phạm Huy Hoàng
  ...
  await Comment.create({
    post: p5._id,
    author: users['20233848']._id, // Nguyễn Thị Thu Hà
  ...
  await Comment.create({
    post: p5._id,
    author: users['20233846']._id, // Phạm Bắc Đại Dương
  ...
  const p6 = await Post.create({
    ...
    topic: 'doi-song',
    author: users['20233844']._id, // Phạm Danh Tuấn Dũng
    status: 'approved',
    views: 312,
    shares: 20,
  });
  ...
  await Comment.create({
    post: p6._id,
    author: users['20233842']._id, // Lưu Trí Dũng
  ...
  await Comment.create({
    post: p6._id,
    author: users['20233840']._id, // Trương Công Đức
  ...
  const c6_3 = await Comment.create({
    post: p6._id,
    author: users['20233838']._id, // Lê Duy Đức
  ...
  await Comment.create({
    post: p6._id,
    parent: c6_3._id,
    author: users['20233836']._id, // Nguyễn Tiến Đạt
  ...
  const p7 = await Post.create({
    ...
    topic: 'doi-song',
    author: users['20233834']._id, // Nguyễn Thị Mai Chinh
    status: 'approved',
    views: 180,
    shares: 2,
  });
  ...
  await Comment.create({
    post: p7._id,
    author: users['20233832']._id, // Vũ Xuân Anh
  ...
  await Comment.create({
    post: p7._id,
    author: users['20233830']._id, // Trần Phan Anh
  ...
  const p8 = await Post.create({
    ...
    topic: 'viec-lam',
    author: users['20233828']._id, // Nguyễn Phan Anh
    status: 'approved',
    views: 92,
    shares: 0,
  });
  ...
  const c8_1 = await Comment.create({
    post: p8._id,
    author: users['20233826']._id, // Đoàn Duy Anh
  ...
  await Comment.create({
    post: p8._id,
    parent: c8_1._id,
    author: users['20233825']._id, // Phạm Nguyễn Tùng An
  ...
  await Comment.create({
    post: p8._id,
    author: users['20233827']._id, // Mai Việt Anh
  ...
  const c8_3 = await Comment.create({
    post: p8._id,
    author: users['20233829']._id, // Nguyễn Vương Thục Anh
  ...
  await Comment.create({
    post: p8._id,
    parent: c8_3._id,
    author: users['20233831']._id, // Trần Thị Vân Anh
  ...
  const p9 = await Post.create({
    ...
    topic: 'viec-lam',
    author: users['20233833']._id, // Bùi Hoàng Bảo
    status: 'approved',
    views: 130,
    shares: 2,
  });
  await Comment.create({
    post: p9._id,
    author: users['20233837']._id, // Đỗ Đại Doanh
  ...
  await Comment.create({
    post: p9._id,
    author: users['20233841']._id, // Hà Trung Dũng
  ...
  await Comment.create({
    post: p9._id,
    author: users['20233843']._id, // Nguyễn Quang Dũng
  ...
  const p10 = await Post.create({
    ...
    topic: 'viec-lam',
    author: users['20233845']._id, // Bùi Nam Dương
    status: 'approved',
    views: 125,
    shares: 3,
  });
  await Comment.create({
    post: p10._id,
    author: users['20233835']._id, // Lưu Tiến Đạt
  ...
  await Comment.create({
    post: p10._id,
    author: users['20233839']._id, // Tạ Minh Đức
  ...
  await Comment.create({
    post: p10._id,
    author: users['20233847']._id, // Nguyễn Đình Hoàng Hà
  ...
  // --- ADDITIONAL POSTS WITH OTHER STATUSES ---
  ...
  await Post.create({
    ...
    topic: 'hoc-tap',
    author: users['20233849']._id, // Nguyễn Lê Trung Hiếu
    status: 'pending',
    views: 4,
    shares: 0,
  });
  ...
  await Post.create({
    ...
    topic: 'tai-lieu',
    author: users['20233851']._id, // Hà Duyên Hùng
    status: 'rejected',
  ...
  const p13 = await Post.create({
    ...
    topic: 'doi-song',
    author: users['20233853']._id, // Trần Gia Huy
    status: 'approved',
    views: 64,
    shares: 3,
  });
  p13.ratings.set(String(users['20233885']._id), 5); // Phạm Minh Tuyên
  p13.ratings.set(String(users['20233886']._id), 4); // Lê Hà Hải Vân
  p13.ratings.set(String(users['20233888']._id), 3); // Hoàng Tiểu Yến
  p13.recomputeRating();
  await p13.save();
  ...
  await Post.create({
    ...
    topic: 'viec-lam',
    author: users['20233857']._id, // Dương Văn Kiên
    status: 'approved',
    views: 98,
    shares: 5,
  });
  ...
  await Post.create({
    ...
    topic: 'doi-song',
    author: users['20233859']._id, // Trần Trung Kiên
    status: 'approved',
    views: 45,
    shares: 1,
  });
